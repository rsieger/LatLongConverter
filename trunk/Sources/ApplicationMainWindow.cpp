...
int main( int argc, char *argv[] )
{
    ...
    QCoreApplication::setApplicationName( "LatLongConverter" );
...
void MainWindow::displayHelp()
{
    ...
    {
        QString s_ApplicationName = "LatLongConverter";
...
/*! @brief bestimmt die Groesse einer Datei und gibt eine Groesseklasse zurueck.
*
*   @param  s_FilenameIn Dateiname.
*   @param  i_NumOfFiles anzahl der Datein.
